...
In Hendrik settings, select Add Custom Model, paste the model name from LM Studio, select `lm-studio` as provider, click add, and you'll find it in your model picker!
...
Inside Hendrik settings, click Add Custom Model, enter the model name you pulled from Ollama, e.g. `mistral`, select `ollama` as provider, click add, and you'll find it in your model picker!
...
and start your local Ollama server as before. Now you can add your Ollama embedding model in Hendrik QA settings as `nomic-embed-text` with provider `ollama`, and it will use your local embeddings!
